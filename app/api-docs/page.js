            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  This interactive documentation allows you to try out API calls
                  directly from this page. Click on any endpoint, then click the
                  &quot;Try it out&quot; button to make a real API request.
                </p>
              </div>
            </div>
          </div>
